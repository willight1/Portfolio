...
export function AccountPageClient({ me }: Props) {
  ...
  return (
    <section className="mx-auto max-w-2xl space-y-6">
      <div className="rounded-2xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">username: {me.username || ''}</p>
        <p className="text-sm text-zinc-600 dark:text-zinc-400">email: {me.email || '-'}</p>
      </div>
